<?php
  if (isset($_POST['submit'])) {
    ...
    $resultado = mysqli_query($conexao, "INSERT INTO usuarios(nome,email,senha) VALUES ('$nome','$email',md5('$senha'))");
    ...
    <div class="container">
      ...
      <div class="parte-direita">
        <form action="index.php" method="post">
          <section class="topo">
            <h2>Cadastre-se</h2>
            <p>Já possui uma conta? <a href="login.php"><strong>Entrar</strong></a></p>
          </section>
